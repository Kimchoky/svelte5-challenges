<details>
    ...
    <h6>Features</h6>
    <ul>
        <li><input type="checkbox" disabled >Allow users to search for a city</li>
        ...
        <li><input type="checkbox" disabled >Use server-side rendering for initial page load</li>
    ...
    <ul>
        <li><input type="checkbox" disabled >Use the browser's geolocation API to get the user's current location</li>
